...
process.on('message', ({pubPID, pubFile})=>{
        (async () => {
            ...
            page.evaluate(()=>{
                ...
                /** @FAILED presumably due to origin "about:blank" */
                // if (window.localStorage) {
                //     page.isClosed ? localStorage.setItem("page_isClosed was written", page.isClosed) : localStorage.setItem("page_isClosed was written", !(page.isClosed) );
                // }
            })
